...
# (0.105, 0.105, 0.205)  # T1Spir_30slices_FOV_coreg
grid = ref.ReferenceGrid(center=(0.109, 0.1095, 0.03))
grid.build()
grid.convert()
...
# roi = ((306, 235, 0), (560, 598, 29))  # T1Spir_30slices_FOV_coreg
roi = ((182, 138, 0), (328, 352, 66))
source = im.ImageGrid("../../im_DICOM/complete_IRM_CBCT/" + name + "/", 66, range_hu=(10, 710), is_mri=True,
                      image_roi=roi)
