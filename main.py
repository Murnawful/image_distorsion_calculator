...
grid = ref.ReferenceGrid(center=(0.135, 0.135, 0.06))
grid.build()
grid.convert()

name = "3DT1_115slices_coreg"
...
source = im.ImageGrid("../../im_DICOM/complete_IRM_CBCT/" + name + "/", 115, range_hu=(250, 600), is_mri=True,
                      image_roi=roi)
source.convert()
